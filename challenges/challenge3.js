 ...
 *
 * this function is different from a typical function because it uses the sytactic sugar of using a await-async function this allows
 * for easier writing functions. Its return type is the resolve of the promise.
 *
 *
 ...
 *
 * 'Promise { <pending> }' is printed inside the terminal
 *
 * 3. Uncomment block #2 and run the code again. What happens now?
 *
 * 'HELLO THERE, DUCKY' is printed printed inside of the terminal.
 *
